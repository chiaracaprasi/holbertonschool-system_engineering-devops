...
[4-to_infinity_and_beyond](./4-to_infinity_and_beyond) | Bash script that displays To infinity and beyond indefinitely with, between each iteration of the loop, a sleep 2
[5-kill_me_now](./5-kill_me_now) | Bash script that kills 4-to_infinity_and_beyond process (must use kill)
[6-kill_me_now_made_easy](./6-kill_me_now_made_easy) | Bash script that kills 4-to_infinity_and_beyond process (cannot use kill or killall)
